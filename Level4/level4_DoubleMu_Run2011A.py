...
#
files = FileUtils.loadListFromFile("../datasets/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10000_file_index.txt")         
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10001_file_index.txt"))        
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_20000_file_index.txt"))  
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('DoubleMu2011A.root')
                                   )
