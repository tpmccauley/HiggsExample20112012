...
#
files = FileUtils.loadListFromFile("../datasets/CMS_Run2011A_DoubleElectron_AOD_12Oct2013-v1_20000_file_index.txt")
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2011A_DoubleElectron_AOD_12Oct2013-v1_20001_file_index.txt")) 
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('DoubleElectron2011A.root')
                                   )
