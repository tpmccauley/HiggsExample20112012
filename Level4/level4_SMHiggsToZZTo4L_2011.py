...
files = FileUtils.loadListFromFile("../datasets/mc_lists/CMS_MonteCarlo2011_Summer11LegDR_SMHiggsToZZTo4L_M-125_7TeV-powheg15-JHUgenV3-pythia6_AODSIM_PU_S13_START53_LV6-v1_20000_file_index.txt")
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('SMHiggsToZZTo4L_2011.root')
                                   )
