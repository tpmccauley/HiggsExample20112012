...
files = FileUtils.loadListFromFile("../datasets/mc_lists/CMS_MonteCarlo2012_Summer12_DR53X_ZZTo4e_8TeV-powheg-pythia6_AODSIM_PU_RD1_START53_V7N-v2_20000_file_index.txt")
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('ZZto4e_2012.root')
                                   )
