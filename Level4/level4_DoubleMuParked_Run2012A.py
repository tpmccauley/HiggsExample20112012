...
files = FileUtils.loadListFromFile("../datasets/CMS_Run2012A_DoubleMuParked_AOD_22Jan2013-v1_20000_file_index.txt")
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('DoubleMuParked2012A.root')
                                   )
