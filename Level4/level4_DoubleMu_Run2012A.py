...
files = FileUtils.loadListFromFile("../datasets/CMS_Run2012A_DoubleMu_AOD_22Jan2013-v1_20000_file_index.txt")
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2012A_DoubleMu_AOD_22Jan2013-v1_30000_file_index.txt"))
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('DoubleMu2012A.root')
                                   )
