...
files = FileUtils.loadListFromFile("../datasets/CMS_Run2012B_DoubleElectron_AOD_22Jan2013-v1_20000_file_index.txt")
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2012B_DoubleElectron_AOD_22Jan2013-v1_30000_file_index.txt"))
files.extend(FileUtils.loadListFromFile("../datasets/CMS_Run2012B_DoubleElectron_AOD_22Jan2013-v1_20001_file_index.txt"))
...
process.TFileService = cms.Service("TFileService",
       fileName = cms.string('DoubleElectron2012B.root')
                                   )
